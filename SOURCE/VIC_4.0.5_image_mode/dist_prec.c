...
static char vcid[] = "$Id: dist_prec.c,v 4.2.2.1 2004/05/06 00:37:52 tbohn Exp $";
...
/* modified by Lifeng Luo April 11, 2005
    *change [rec] to [rec+1] 
    *also move the following section from the beginning of the subroutine
    *to the end of the subroutine.
    *therefore, writing the state after the current day is calculated. */
...
/* done with modification by Lifeng Luo */
}
