 ...
 */
/***** Version Information *****/
#define VERSION		"VIC Release 4.0.5"
...
#define NLDAS_LL_LAT      25.0625
#define NLDAS_LL_LON    -124.9375
...
typedef struct {
  ...
  char   GRID_INPUT;         /** TRUE: Gridded Intput; FALSE: Point-wise Input **/
  char   GRID_OUTPUT;        /** TRUE: Gridded Output **/
  char   REGULAR_OUTPUT;     /** TRUE: Regular Point-wise Output **/
  char   OUTPUT_PER_STEP;    /** TRUE: Gridded output written per time step **/
  
  /* Input Grid Definition */
  int    INPUT_GRID_NX;
  int    INPUT_GRID_NY;
  double INPUT_GRID_XO;
  double INPUT_GRID_YO;
  double INPUT_GRID_DX;
  double INPUT_GRID_DY;
  /* Output Grid Definition */
  int    OUTPUT_GRID_NX;
  int    OUTPUT_GRID_NY;
  double OUTPUT_GRID_XO;
  double OUTPUT_GRID_YO;
  double OUTPUT_GRID_DX;
  double OUTPUT_GRID_DY;
