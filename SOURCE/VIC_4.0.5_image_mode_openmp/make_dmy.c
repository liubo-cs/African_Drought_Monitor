...
static char vcid[] = "$Id: make_dmy.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
**********************************************************************/
{
  ...
  /* reduce nrecs by 1 to avoid reading the forcing from the last day specified in global control file*/
  global->nrecs--;
  /*Modifed by Lifeng Luo, April 11, 2005*/
  return temp;
}
